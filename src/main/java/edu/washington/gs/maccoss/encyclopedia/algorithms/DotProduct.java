...
public class DotProduct implements PSMScorer {
	...
	/* (non-Javadoc)
	 * @see edu.washington.gs.maccoss.encyclopedia.algorithms.PSMScorer#score(edu.washington.gs.maccoss.encyclopedia.datastructures.LibraryEntry, edu.washington.gs.maccoss.encyclopedia.datastructures.Swath)
	 */
	public float score(LibraryEntry entry, Swath spectrum) {
