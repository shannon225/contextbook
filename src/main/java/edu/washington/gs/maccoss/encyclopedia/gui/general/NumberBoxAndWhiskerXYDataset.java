...
public class NumberBoxAndWhiskerXYDataset extends AbstractXYDataset implements BoxAndWhiskerXYDataset, RangeInfo {
	 ...
	 */
	public NumberBoxAndWhiskerXYDataset(Comparable seriesKey) {
		this.seriesKey = seriesKey;
		this.xValues = new ArrayList<Number>();
	 ...
	 *
	 * @param outlierCoefficient being a <code>double</code> representing the value
	 *                           used to calculate outliers.
	 *
	 ...
	 *
	 * @param faroutCoefficient being a <code>double</code> representing the value
	 *                          used to calculate farouts.
	 *
	 ...
	 */
	public void add(Number xvalue, BoxAndWhiskerItem item) {
	 ...
	 *
	 * @param series the series index (ignored, since this dataset contains only one
	 *               series).
	...
	public Number getX(int series, int item) {
		return this.xValues.get(item);
	}

	/**
	 * Returns the y-value for one item in a series.
	 * <p>
	 * This method (from the XYDataset interface) is mapped to the getMeanValue()
	 * method.
	 *
	 * @param series the series (zero-based index).
	 * @param item   the item (zero-based index).
	 ...
	 *
	 * @param includeInterval a flag that determines whether or not the y-interval
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof NumberBoxAndWhiskerXYDataset)) {
			return false;
		}
		NumberBoxAndWhiskerXYDataset that = (NumberBoxAndWhiskerXYDataset) obj;
		if (!ObjectUtilities.equal(this.seriesKey, that.seriesKey)) {
			return false;
		}
		if (!this.xValues.equals(that.xValues)) {
			return false;
		}
	...
	public Object clone() throws CloneNotSupportedException {
		NumberBoxAndWhiskerXYDataset clone = (NumberBoxAndWhiskerXYDataset) super.clone();
		clone.xValues = new java.util.ArrayList<>(this.xValues);
