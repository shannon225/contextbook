	...
	public static Pair<TDoubleIntHashMap[], ArrayList<String>[]> generateBackground(double[] binBoundaries, Collection<FastaEntryInterface> entries, boolean digest, PecanSearchParameters params) {
		...
		for (FastaEntryInterface entry : entries) {
			...
			if (digest) {
				...
				for (FastaPeptideEntry peptide : params.getEnzyme().digestProtein(entry, params.getMinPeptideLength(), params.getMaxPeptideLength(), params.getMaxMissedCleavages(), params.getAAConstants())) {
