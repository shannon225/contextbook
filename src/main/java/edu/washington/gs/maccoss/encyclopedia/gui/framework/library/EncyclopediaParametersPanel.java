...
public class EncyclopediaParametersPanel extends JPanel implements ParametersPanelInterface {
	...
	private SearchParameters getParameters() {
		...
		SearchParameters parameters=new SearchParameters(aaConstants, fragmentation, new MassTolerance(precursorPPMValue), new MassTolerance(fragmentPPMValue), digestionEnzyme, 0.01f, null, dataAcquisitionType, numberOfJobsValue, 25f, -1f, precursorWindowWidthValue, false, false);
		return parameters;
	}
}
