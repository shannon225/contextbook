...
public enum IonType {
	...
	public static final Color missingColor=Color.BLUE; //DARK_GRAY;
	...
	public static final BasicStroke missingStroke=new BasicStroke(2.0f, BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND);
