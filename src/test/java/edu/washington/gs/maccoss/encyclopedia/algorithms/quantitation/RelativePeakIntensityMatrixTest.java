...
public class RelativePeakIntensityMatrixTest extends TestCase {
	...
	public void testELHPVLK() {
		...
		LibraryEntry XXX_2019_0304_RJ_12_2_ELHPVLK=new LibraryEntry("XXX_2019_0304_RJ_12_2.mzML", new HashSet<String>(), 1, 418.2554458086647, (byte)2, "ELHPVLK", 1, 2835.5513f, 0.0930104f, massArray, intensityArray, correlationArray, quantifiedIons, aaConstants);
		...
		quantifiedIons=new boolean[correlationArray.length]; Arrays.fill(quantifiedIons, true);
		LibraryEntry XXX_2019_0304_RJ_13_3_ELHPVLK=new LibraryEntry("XXX_2019_0304_RJ_13_3.mzML", new HashSet<String>(), 1, 418.2554458086647, (byte)2, "ELHPVLK", 1, 2852.5515f, 0.133916f, massArray, intensityArray, correlationArray, quantifiedIons, aaConstants);
		...
		quantifiedIons=new boolean[correlationArray.length]; Arrays.fill(quantifiedIons, true);
		LibraryEntry XXX_2019_0304_RJ_16_4_ELHPVLK=new LibraryEntry("XXX_2019_0304_RJ_16_4.mzML", new HashSet<String>(), 1, 418.2554458086647, (byte)2, "ELHPVLK", 1, 2863.515f, 0.124273f, massArray, intensityArray, correlationArray, quantifiedIons, aaConstants);
		...
		quantifiedIons=new boolean[correlationArray.length]; Arrays.fill(quantifiedIons, true);
		LibraryEntry XXX_2019_0304_RJ_23_9_ELHPVLK=new LibraryEntry("XXX_2019_0304_RJ_23_9.mzML", new HashSet<String>(), 1, 418.2554458086647, (byte)2, "ELHPVLK", 1, 2850.8184f, 0.126865f, massArray, intensityArray, correlationArray, quantifiedIons, aaConstants);
		...
		quantifiedIons=new boolean[correlationArray.length]; Arrays.fill(quantifiedIons, true);
		LibraryEntry XXX_2019_0304_RJ_24_12_ELHPVLK=new LibraryEntry("XXX_2019_0304_RJ_24_12.mzML", new HashSet<String>(), 1, 418.2554458086647, (byte)2, "ELHPVLK", 1, 2797.564f, 0.0887852f, massArray, intensityArray, correlationArray, quantifiedIons, aaConstants);
		...
		quantifiedIons=new boolean[correlationArray.length]; Arrays.fill(quantifiedIons, true);
		LibraryEntry XXX_2019_0304_RJ_26_14_ELHPVLK=new LibraryEntry("XXX_2019_0304_RJ_26_14.mzML", new HashSet<String>(), 1, 418.2554458086647, (byte)2, "ELHPVLK", 1, 2818.936f, 0.0736802f, massArray, intensityArray, correlationArray, quantifiedIons, aaConstants);
		...
		quantifiedIons=new boolean[correlationArray.length]; Arrays.fill(quantifiedIons, true);
		LibraryEntry XXX_2019_0304_RJ_34_20_ELHPVLK=new LibraryEntry("XXX_2019_0304_RJ_34_20.mzML", new HashSet<String>(), 1, 418.2554458086647, (byte)2, "ELHPVLK", 1, 2783.1426f, 0.113011f, massArray, intensityArray, correlationArray, quantifiedIons, aaConstants);
