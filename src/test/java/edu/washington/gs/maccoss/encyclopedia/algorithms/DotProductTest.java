...
public class DotProductTest extends TestCase {
	...
	public void testEmptyDotProduct() {
		...
		assertEquals(0.0f, new DotProduct(new MassTolerance(100.0f)).score(entry, spectrum, null));
	}
	public void testDotProduct() {
		...
		assertEquals(32.0f, new DotProduct(new MassTolerance(1000.0f)).score(entry, spectrum, null));
		assertEquals(20.0f, new DotProduct(new MassTolerance(100.0f)).score(entry, spectrum, null));
		assertEquals(0.0f, new DotProduct(new MassTolerance(10.0f)).score(entry, spectrum, null));
	}
