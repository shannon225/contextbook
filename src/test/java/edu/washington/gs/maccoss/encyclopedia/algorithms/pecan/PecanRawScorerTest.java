...
public class PecanRawScorerTest extends TestCase {
	...
	public void testGetIndividualPeakScores() {
		...
		Stripe spectrum=getStripe(new double[] {1000.0, 1000.01, 1000.02, 1000.03, 1000.04, 1000.05}, new float[] {10.0f, 100.0f, 50.0f, 10.0f, 1.0f, 100f});
		...
		for (int i=0; i<scores.length; i++) {
			if (scores[i]!=null) {
				System.out.println(i+") "+entry.getMassArray()[i]+"\t"+scores[i].getScore()+"\t"+scores[i].getDeltaMass());
			}
		}
	}
