		...
		final class ForceNonstandardTestFDRParams extends SearchParameters {
			...
			public ForceNonstandardTestFDRParams(SearchParameters params, float testFdr) {
				super(
						...
						params.getMinIntensity(), params.isUseIITNumberOfIonsThreshold(), params.getLocalizingModification(), params.getScoringBreadthType(),
						...
						params.isSubtractBackground(), params.isMaskBadIntegrations(), params.isIntegratePrecursors(), params.isEnableAdvancedOptions()
				);
